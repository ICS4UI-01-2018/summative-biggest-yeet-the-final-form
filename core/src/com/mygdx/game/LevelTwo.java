...
public class LevelTwo extends Level {
    ...
    public void create() {
        ...
        super.platforms.add(new Platform(34, 7, 8, 2));
        super.platforms.add(new Platform(34, 9, 4, 1));
        super.platforms.add(new Platform(33, 7, 1, 23));
